        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#cta" className="hover:text-white transition-colors">Consultoria</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="tel:+5562999999999" className="hover:text-white transition-colors">+55 (62) 99999-9999</a></li>
