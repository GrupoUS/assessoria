...
const InputPanel = ({
  ...
  return <div className="lg:col-span-1">
      <div className="bg-white dark:bg-navy-dark p-6 shadow space-y-6 transition-transform duration-300 hover:scale-[1.03] hover:shadow-xl mx-0 px-[24px] py-[24px] rounded-lg">
        <div>
