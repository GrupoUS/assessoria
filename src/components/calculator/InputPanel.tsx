...
const InputPanel = ({
  ...
  return <div className="lg:col-span-1">
      <div className="bg-white dark:bg-navy-dark p-6 shadow space-y-6 transition-transform duration-300 hover:scale-[1.08] hover:shadow-xl rounded-xl px-[18px] py-[20px] mx-0">
        <div>
