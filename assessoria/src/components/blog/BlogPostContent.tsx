      ...
      <div className="max-w-4xl mx-auto">
        <article className="bg-white dark:bg-navy-dark shadow-md rounded-lg p-8 md:p-10">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none blog-content
                          ...
                          prose-h1:text-3xl prose-h1:md:text-4xl prose-h1:lg:text-5xl prose-h1:mb-8 prose-h1:mt-0 prose-h1:leading-tight
                          prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:mb-6 prose-h2:mt-12 prose-h2:leading-tight
                          prose-h3:text-xl prose-h3:md:text-2xl prose-h3:mb-5 prose-h3:mt-10 prose-h3:leading-tight
                          prose-h4:text-lg prose-h4:md:text-xl prose-h4:mb-4 prose-h4:mt-8 prose-h4:leading-tight
                          prose-h5:text-base prose-h5:md:text-lg prose-h5:mb-4 prose-h5:mt-6 prose-h5:leading-tight
                          prose-h6:text-sm prose-h6:md:text-base prose-h6:mb-3 prose-h6:mt-6 prose-h6:leading-tight
