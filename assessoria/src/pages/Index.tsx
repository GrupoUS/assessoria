...
import { optimizeViewport } from '@/utils/performance';
import { useEffect } from 'react';

const Index = () => {
  // Otimizar viewport para dispositivos móveis
  useEffect(() => {
    optimizeViewport();
  }, []);
  return (
    <div className="min-h-screen bg-white dark:bg-navy-darkest text-darkBlue dark:text-white transition-colors duration-300">
      ...
      <StructuredData 
        type="Organization"
        data={{
          "description": "Consultoria financeira especializada em planejamento patrimonial e gestão de investimentos para pessoas com patrimônio acima de R$300 mil."
        }}
      />
      <Navbar />
      <HeroSection />
